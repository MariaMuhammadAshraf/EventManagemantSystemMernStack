...
//     e.preventDefault();
//     const url = isEditMode ? `http://localhost:5000/api/expos/${selectedExpo._id}` : "http://localhost:5000/api/expos";
...
//     await fetch(`http://localhost:5000/api/expos/${id}`, { method: "DELETE" });
//     fetchExpos();
//   };
...
//       ? `http://localhost:5000/api/expos/${selectedExpo._id}`
